...
"""
This module contains dataclasses and builders for GPU model inputs.
"""
...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    def add_seq_group(self, seq_group_metadata: SequenceGroupMetadata):
        ...
        seq_ids = list(seq_group_metadata.seq_data.keys()) # Ensure list for consistent ordering if not already
        n_seqs = len(seq_ids)
    ...
    def build(self) -> ModelInputForGPU:
        ...
        if cuda_graph_pad_size: # cuda_graph_pad_size can be 0
